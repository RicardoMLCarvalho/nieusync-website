          ...
          <div style={{ display: 'grid', gridTemplateColumns: '55% 42%', gap: '48px', alignItems: 'center' }} className="hero-grid">
            <div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.78)', fontSize: '17px', maxWidth: '520px', marginBottom: '36px' }}>
                Direito Empresarial, Compliance, Gestão Estratégica, Marketing Digital e Tecnologias de Informação integrados num único parceiro de confiança.
              </p>
        ...
        <div className="container">
          ...
          <div className="services-orbit animate-on-scroll" style={{ position: 'relative', width: '350px', height: '350px', margin: '60px auto 0', overflow: 'visible' }}>
            ...
            {[
              ...
              { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--blue)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>, label: 'Compliance', href: '/servicos#compliance', angle: 126 },
      ...
      <section style={{ background: 'var(--bg)', padding: '80px 0' }}>
        <div className="container">
          <div className="animate-on-scroll" style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <p style={{ color: 'rgba(35,56,119,0.60)', maxWidth: '460px', margin: '0 auto' }}>Artigos práticos de Direito Empresarial, Compliance, Gestão Estratégica, Marketing Digital, Tecnologias de Informação e Inteligência Artificial, focados especialmente em empresas.</p>
          </div>
          <BlogPreview />
