...
export default function Contacto() {
  ...
  const contactItems = [
    ...
    { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12" y2="18.01"/></svg>, label: 'Telemóvel / WhatsApp', value: '(+351) 933 644 596', href: 'tel:+351933644596' },
            ...
            <div className="animate-on-scroll">
              ...
              <div className="card">
                ...
                <p style={{ fontSize: '14px', color: 'rgba(35,56,119,0.65)', marginBottom: '16px' }}>
                  Escolha o horário que melhor se adequa à sua agenda, que nós confirmamos a disponibilidade o mais rapidamente possível. Reunião presencial, por videochamada ou telefone.
                </p>
