      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'start', direction: reverse ? 'rtl' : 'ltr' }} className="service-layout">
          <div style={{ direction: 'ltr' }} className="animate-on-scroll">
            ...
            <div className="accent-line" style={{ width: '100%', background: 'var(--blue)', backgroundImage: 'none' }} />
          ...
          <div style={{ direction: 'ltr' }} className="animate-on-scroll">
            <div style={{ background: 'rgba(159,142,194,0.08)', borderLeft: '4px solid', borderImage: 'var(--grad-vertical) 1', borderRadius: '0 12px 12px 0', padding: '24px 28px' }}>
