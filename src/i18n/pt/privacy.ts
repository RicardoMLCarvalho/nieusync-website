  ...
  sections: [
    {
      ...
      content:
        'A NIEUSYNC é a entidade responsável pelo tratamento dos seus dados pessoais. Para exercer os seus direitos ou colocar questões relacionadas com a privacidade, contacte: geral@nieusync.com | (+351) 269 030 096.',
    },
    {
    ...
    },
    {
      ...
      content:
        'Para exercer os seus direitos, contacte geral@nieusync.com. Responderemos no prazo de 30 dias. Tem ainda o direito de apresentar reclamação à Comissão Nacional de Protecção de Dados (CNPD), em www.cnpd.pt.',
    },
    {
      title: 'Segurança dos Dados',
      content:
        'Implementamos medidas técnicas e organizativas adequadas para proteger os seus dados contra acesso não autorizado, perda, destruição ou divulgação. Utilizamos encriptação SSL/TLS em todas as comunicações.',
    },
    {
      title: 'Transferências Internacionais',
      content:
        'Alguns dos nossos prestadores de serviços podem estar localizados fora da UE/EEE. Nestes casos, asseguramos que as transferências se realizam com as garantias adequadas, incluindo cláusulas contratuais-tipo aprovadas pela Comissão Europeia.',
    },
  ],
};
