import type { CookiePolicy } from '../en/cookiePolicy';
...
const cookiePolicy: CookiePolicy = {
  ...
  sections: [
    ...
    },
    {
      ...
      content:
        'Determinadas ferramentas (analítica, A/B testing, publicidade) implicam cookies de terceiros e transferência de dadospara fora do EEE. Nesses casos, aplicamos medidas adequadas (contratuais e técnicas) e só ativamos a recolha após consentimento.',
    },
    {
      title: 'Retenção e revisão',
      content:
        'Conservamos registos de consentimento e revemos periodicamente os cookies, fornecedores e finalidades. Atualizaremos esta Política sempre que houver alterações relevantes.',
    },
  ],
};
