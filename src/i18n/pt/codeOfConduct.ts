import type { CodeOfConduct } from '../en/codeOfConduct';
...
const codeOfConduct: CodeOfConduct = {
  ...
  sections: [
    ...
    },
    {
      ...
      content:
        'Tratamos os dados pessoais com o máximo rigor e em conformidade com o Regulamento Geral sobre a Protecção de Dados (RGPD). Não partilhamos informação confidencial de clientes com terceiros sem consentimento expresso.',
    },
    {
    ...
    },
    {
      ...
      content:
        'Qualquer violação deste Código de Conduta deve ser reportada através de geral@nieusync.com. Garantimos a confidencialidade do denunciante e não permitimos retaliações contra quem reporte violações de boa-fé.',
    },
  ],
};
