import type { AcceptableUse } from '../en/acceptableUse';

const acceptableUse: AcceptableUse = {
  ...
  sections: [
    {
      ...
      content:
        'Esta Política de Uso Aceitável aplica-se a todos os utilizadores do website da NIEUSYNC, clientes dos nossos serviços e qualquer pessoa que interaja com a NIEUSYNC de forma digital. Ao utilizar os nossos serviços, o utilizador aceita cumprir estas regras.',
    },
    {
    ...
    },
    {
      title: 'Alterações',
      content:
        'Podemos atualizar esta Política de Uso Aceitável para refletir alterações legais ou operacionais. A versão vigente será publicada no Website com data de revisão.',
    },
  ],
};
