...
const terms: Terms = {
  ...
  sections: [
    ...
    },
    {
      title: 'Indemnização',
      content:
        'O Utilizador concorda em indemnizar a NIEUSYNC por quaisquer perdas, custos e despesas (incl. honorários legais) resultantes de violação destes Termos ou de utilização ilícita do Website.',
    },
    {
      title: 'Força Maior',
      content:
        'A NIEUSYNC não é responsável por incumprimentos resultantes de eventos fora do seu controlo razoável (p. ex., falhas de rede, ciber ataques, catástrofes naturais, entre outros).',
    },
    {
